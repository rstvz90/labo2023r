...
PARAM <- list()
PARAM$experimento <- "TS6410_exp6"

PARAM$exp_input <- "FE6310_exp6"
...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912,
  201911, 201910, 201909, 201908, 201907
)

PARAM$train$training <- c(
  202103, 202102, 202101,
  202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003,  202002, 202001, 201912, 201911,
