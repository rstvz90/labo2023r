...
PARAM <- list()
PARAM$experimento <- "TS6410_exp8"

PARAM$exp_input <- "FE6310_exp8"
...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008, 202004, 202002, 202001, 201912,
  201911, 201910, 201909, 201908, 201907
)

PARAM$train$training <- c(
  202103, 202102, 202101,
  202012, 202011, 202010, 202009, 202008, 202004, 202002, 202001, 201912, 201911,
